...
const NewOrder = (props) => {
  ...
  return (
    ...
    >
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Location Code" name="locationCode" rules={[{ required: true, message: "Please enter location code!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
        <Form.Item label="Customer Cordinator" name="customerCordinator" rules={[{ required: true, message: "Please select customer cordinator!" }]}>
            <Select placeholder="Customer Cordinator">
            {cordinators
                .filter((cordinator) => cordinator.cordinatorType === 'Customer')
                .map((cordinator,index) => (
                  <Option key={index} value={cordinator.id}>{cordinator.cordinatorName}</Option>
                ))}
            </Select>
          </Form.Item>
        </Col>
        ...
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item
            ...
            rules={[
                { required: true, message: "Please enter customer cordinator number!" },
      ...
      <Row gutter={16}>
        ...
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item
            ...
            rules={[
                { required: true, message: "Please enter source cordinator number!" },
                { validator: validateContactNumber },
              ]}
          >
            <Input />
      ...
      <Row gutter={16}>
        ...
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item
            ...
            rules={[
                { required: true, message: "Please enter factory cordinator number!" },
                { validator: validateContactNumber },
              ]}
          >
            <Input />
      ...
      <Row gutter={16}>
        ...
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Sale Value" name="saleValue" rules={[{ required: true, message: "Please enter sale value!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Material Value" name="materialValue" rules={[{ required: true, message: "Please enter material value!" }]}>
            <Input placeholder="Material Value" />
          </Form.Item>
        </Col>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Face Area" name="faceArea" rules={[{ required: true, message: "Please enter face area!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Target Start Date" name="targetStartDate" rules={[{ required: true, message: "Please select target start date!" }]}>
            <DatePicker style={{ width: "100%" }} />
          </Form.Item>
        </Col>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Target End Date" name="targetEndDate" rules={[{ required: true, message: "Please select target end date!" }]}>
            <DatePicker style={{ width: "100%" }} />
          </Form.Item>
        </Col>
      </Row>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Total Service" name="totalService" rules={[{ required: true, message: "Please enter total services!" }]}>
            <Input placeholder="Total Services" />
          </Form.Item>
        </Col>
        <Col lg={12} sm={24} xs={24} md={12}>
      ...
      <Row gutter={16}>
        ...
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Service Calendar" name="serviceCalendar" rules={[{ required: true, message: "Please enter service calendar!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Estimated Cost" name="estimatedCost" rules={[{ required: true, message: "Please enter estimated cost!" }]}>
            <Input placeholder="Estimated Cost" />
          </Form.Item>
        </Col>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Actual Cost" name="actualCost" rules={[{ required: true, message: "Please enter actual cost!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Attachment" name="attachment" rules={[{ required: true, message: "Please enter attachment!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item label="Expense Till Date" name="expenseTillDate" rules={[{ required: true, message: "Please enter expense till date!" }]}>
      ...
      <Row gutter={16}>
        <Col lg={12} sm={24} xs={24} md={12}>
          <Form.Item
            ...
            rules={[{ required: true, message: "Please enter estimated quote after discount!" }]}
          >
